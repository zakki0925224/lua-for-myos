...
/* Use hardcoded decimal point instead of localeconv */
...
/* tmpnam is not supported in minimal libc */
#define lua_tmpnam(b, e) ((void)(b), (e) = 1)
#define LUA_TMPNAMBUFSIZE 32

/* popen is not supported */
#undef LUA_USE_POPEN

/*
** Integer Only Mode Configuration
** Undefine defaults to avoid redefinition warnings
*/
#undef LUA_INT_TYPE
...
/* Conversions (Force integer parsing) */
#define lua_str2number(s, p) ((lua_Number)strtol((s), (p), 10))
#define lua_number2str(s, n) sprintf((s), LUA_NUMBER_FMT, (n))

/* Math helper macros for Integer mode */
#define l_mathop(op) op
#define l_floor(x) ((lua_Number)(x))
